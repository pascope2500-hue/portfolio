...
export default function SkillBadge({ name, level }: SkillBadgeProps) {
  const getLevelColor = () => {
    switch (level) {
      ...
      case "Intermediate":
        return "bg-primary/15 text-primary-foreground border border-primary/70 hover:bg-primary/60"
      case "Advanced":
        return "bg-primary/30 text-primary-foreground border border-primary/85 hover:bg-primary/75"
      case "Expert":
